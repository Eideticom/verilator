...
- patch at `branch: v5.004-vpi-callback-patch <https://github.com/Eideticom/verilator/tree/v5.002-vpi-callback-patch>`_ (:code:`git checkout v5.002-vpi-callback-patch`)
- cocotb_ver="1.7.1"
